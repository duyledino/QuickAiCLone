...
const RemoveBackground = () => {
  ...
  return (
    <>
    <motion.div initial={{opacity:0,translateY:"10px"}} animate={{opacity:1,translateY:0}} transition={{duration: 0.3}}  className="p-3 flex flex-wrap  gap-5">
      <div>
        <Configuration
          className={
        ...
        >
          ...
          >
            ...
            <div className="text-[14px] flex flex-col gap-2">
              ...
              />
              <h1 className="text-[12px] text-gray-400">Supports JPG, PNG, and other image formats</h1>
            </div>
        ...
        >
          <div className="flex flex-col w-full h-full gap-2 p-4">
            ...
            <div className="w-full h-[90%]">
              {content !== null ? (
                <img src={content} alt="content" className="w-full h-auto object-contain"/>
              ) : (
                <ContentInstruction />
              )}
            </div>
